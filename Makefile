...
VOLT=volt
SRC=src\watt\*.volt src\watt\io\*.volt src\watt\io\streams\*.volt src\watt\text\*.volt src\watt\math\*.volt src\watt\text\json\*.volt src\watt\process\*.volt src\watt\http\*.volt
