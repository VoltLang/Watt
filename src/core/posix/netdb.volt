 ...
 */
module core.posix.netdb;

//private import core.sys.posix.config;
//public import core.stdc.inttypes;         // for uint32_t
public import core.posix.netinet.in_; // for in_port_t, in_addr_t
//public import core.sys.posix.sys.types;   // for ino_t
public import core.posix.sys.socket;  // for socklen_t
...
version( Linux )
{
    struct hostent
    {
        ...
        int     h_length;
        char**  h_addr_list;
        @property char*   h_addr() { return h_addr_list[0]; } // non-standard
    }
